...
4. Próximo passo imediato:
   - manter consolidação operacional da janela de 30 dias em `READY` e `severity=normal`, com persistência recorrente no banco e leitura de tendência via `/v1/ops/robustness-history`.
