...
describe("App shell", () => {
  it("renders navigation and child content", () => {
    ...
    expect(screen.getByRole("link", { name: /Cen[aá]rios|Cenarios/i })).toBeInTheDocument();
    ...
    expect(screen.getByRole("link", { name: /Pular para o conte[uú]do principal|Pular para o conteudo principal/i })).toBeInTheDocument();
