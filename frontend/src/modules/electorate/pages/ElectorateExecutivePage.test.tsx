      ...
      return {
        ...
        items: [
          ...
          },
          {
            ...
            votes: 420,
            share_percent: 8.75,
            polling_place_name: "Escola B",
            polling_place_code: "203",
            district_name: "Mendanha",
            zone_codes: ["101"],
            section_count: 2,
            sections: ["77", "78"],
            polling_place_section_count: 2,
            polling_place_sections: ["77", "78"],
          },
        ],
      };
    }
